...
public class SightList {
    ...
    public void setArrayListOfSightData(AssetManager assets) {
        try {
           InputStream inputStream = assets.open("sights.json");
            ...
            Log.d("aaaa", "sights json parsing error is " + e.toString());
        }
    ...
    public void setLocationInfo() {
        try {
            ...
            for (int indexOfSight = 0; indexOfSight < locationInfo.length(); indexOfSight++) {
                if (locationInfo.getJSONObject(indexOfSight).getString("homepage") == null || "".equals(locationInfo.getJSONObject(indexOfSight).getString("homepage")) || "null".equals(locationInfo.getJSONObject(indexOfSight).getString("facility_lat")) || locationInfo.getJSONObject(indexOfSight).getString("facility_lat") == null || "null".equals(locationInfo.getJSONObject(indexOfSight).getString("facility_lon")) || locationInfo.getJSONObject(indexOfSight).getString("facility_lon") == null || locationInfo.getJSONObject(indexOfSight).getString("facility_nm") == null || locationInfo.getJSONObject(indexOfSight).getString("brtc_nm") == null || locationInfo.getJSONObject(indexOfSight).getString("images") == null) {
                    continue;
                }
                this.arrayListOfSightData.add(new SightsData(indexOfSight, Double.valueOf(locationInfo.getJSONObject(indexOfSight).getString("facility_lat")), Double.valueOf(locationInfo.getJSONObject(indexOfSight).getString("facility_lon")), locationInfo.getJSONObject(indexOfSight).getString("facility_nm"), locationInfo.getJSONObject(indexOfSight).getString("brtc_nm"), locationInfo.getJSONObject(indexOfSight).getString("homepage"), locationInfo.getJSONObject(indexOfSight).getString("images")));
                Log.d("aaaa", "Lat And Long is " + Double.valueOf(locationInfo.getJSONObject(indexOfSight).getString("facility_lat")) + ", " + Double.valueOf(locationInfo.getJSONObject(indexOfSight).getString("facility_lon")));
            }
        }catch (Exception e) {
            Log.d("aaaa", "setLocationInfo Error is " + e.toString());
        }
    }
}
